...
function Technologies() {
  return (
    <div className={styles.main} id="tech">
      <h1>III. Technologies and Dev Stack</h1>
      ...
      <button><a href='mailto:alaminxab@gmail.com' target="_blank">SEND AN EMAIL</a></button>
      <button><a href='https://drive.google.com/file/d/1pok_qZTxcZ49Myq2_ySHKlNSvbwViUxW/view?usp=drivesdk' target="_blank">VIEW MY RESUME</a></button>
    </div>
  )
}
